...
describe('calculateDuration', () => {
	it('should calculate duration correctly', () => {
		...
		const endTime = Temporal.PlainDateTime.from('2023-01-01T11:30:00')
	...
	it('should handle different days', () => {
		...
		const endTime = Temporal.PlainDateTime.from('2023-01-02T01:00:00')
	...
	it('should handle milliseconds precision', () => {
		const startTime = Temporal.PlainDateTime.from('2023-01-01T10:00:00.500')
		const endTime = Temporal.PlainDateTime.from('2023-01-01T10:00:01.200')
	...
	it('should handle very short durations', () => {
		const startTime = Temporal.PlainDateTime.from('2023-01-01T10:00:00')
		const endTime = Temporal.PlainDateTime.from('2023-01-01T10:00:00.001')
