...
describe('formatTime', () => {
	it('should format time in 24-hour format', () => {
		const date1 = new Date('2023-01-01T09:30:00')
		const date2 = new Date('2023-01-01T14:45:00')
		const date3 = new Date('2023-01-01T23:59:00')
	...
	it('should handle single digit hours and minutes', () => {
		const earlyMorning = new Date('2023-01-01T05:05:00')
		const lateNight = new Date('2023-01-01T23:09:00')
