...
describe('validateTimeRange', () => {
	it('should return empty array for valid time range', () => {
		...
		const endTime = new Date('2023-01-01T11:00:00')
	...
	it('should return error when duration exceeds 24 hours', () => {
		...
		const endTime = new Date('2023-01-02T01:00:00') // 25 hours later
		const errors = validateTimeRange(startTime, endTime)
	...
	it('should return both errors when both conditions are violated', () => {
		const startTime = new Date('2023-01-01T11:00:00')
		const endTime = new Date('2023-01-01T10:00:00') // Start after end
		const errors = validateTimeRange(startTime, endTime)
	...
	it('should accept exactly 24 hours duration', () => {
		const startTime = new Date('2023-01-01T00:00:00')
		const endTime = new Date('2023-01-02T00:00:00') // Exactly 24 hours
		const errors = validateTimeRange(startTime, endTime)
	...
	it('should handle different days within 24 hours', () => {
		...
		const endTime = new Date('2023-01-02T22:59:59') // Just under 24 hours
		const errors = validateTimeRange(startTime, endTime)
	...
	it('should handle very short durations', () => {
		const startTime = new Date('2023-01-01T10:00:00')
		const endTime = new Date('2023-01-01T10:00:01') // 1 second
		const errors = validateTimeRange(startTime, endTime)
